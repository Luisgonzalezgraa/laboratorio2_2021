...
socialNetworkToString(SocialNet,SocialNet2):-
    ...
    register2String2(NombreUsuario,Follow,RegisterString),
    string_concat(String6,RegisterString,String7),
    string_concat(String7,"------------------------------------------------\n",String8),
    string_concat(String8,"**************PUBLICACIONES*********************\n",String9),
    ...
    string_concat(String11,"**************PUBLICACIONES COMPARTIDAS*********************\n",String12),
    share2String(Share,Usuario,ShareString),
    string_concat(String12,ShareString,String13),
    string_concat(String13,"**************FIN PUBLICACIONES COMPARTIDAS*********************\n",String14),
 ...
 */
register2String2([],_,""):-!.
register2String2([CabezaArch|Cola],Follow,Lista):-
    Follow == [],
    string_concat(CabezaArch,"\n      sigue a: \n",String),register2String2(Cola,Follow,String2),string_concat(String,String2,Lista),!.
register2String2([CabezaArch|Cola],Follow,Lista):-
    followEnLista(Follow,CabezaArch,ListaFollow),
    obtenerCabeza(ListaFollow,X),
    obtenerMedio(ListaFollow,Y,Z),
    string_concat(X,Y,String),string_concat(String,Z,String2),string_concat(String2,"\n\n",String3),register2String2(Cola,Follow,String4),string_concat(String3,String4,Lista),!;
    string_concat(CabezaArch,"\n      sigue a: \n",Strings),register2String2(Cola,Follow,Strings2),string_concat(Strings,Strings2,Lista),!.
